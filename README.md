...
- [Tracking Google Tag Manager](#tracking-google-tag-manager)
...
```html
<form
  action="https://formspree.io/hello@godofredo.ninja"
...
<div class="godo-ne">
  ...
  <form
    id="godo-form"
    class="godo-ne-form"
    action="YOUR_URL_OF_LIST_Mailchimp"
    method="post"
    target="_blank"
  >
    ...
    <small
      >No marketing campaigns. No jibber jabber. Unsubscribe anytime.</small
    >
  </form>
</div>
```
...
<div class="godo-n-q">
  ...
  <div class="godo-n-q-i u-hide-before-md">
    ...
    <blockquote>
      "I should really get around to organizing some quotes one of these days"
    </blockquote>
  </div>
</div>
```
...
[![ghost newsletter](./documentation/newsletter.jpg)](https://www.behance.net/gallery/89147477/Simply-Newsletter-Page)
...
<p class="spc-des">
  Updates and behind the scenes stories about the world of Ghost. Hosted by
  Ghost founders <em>John O'Nolan</em> &amp; <em>Hannah Wolfe</em>.
</p>
...
<div class="spc-buttons">
  ...
  <a href="https://www.pocketcasts.com/">
    <img
      src="/assets/images/icon-pocketcasts.png"
  ...
  <a href="https://anchor.fm/">
    <img
      src="/assets/images/icon-rss.png"
      style="height:15px"
      alt="RSS Icon"
      rel="presentation"
    />
...
![Google tag Manager Trigger](./documentation/analytics01.jpg)
...
![Google tag manager tag](./documentation/analytics02.jpg)

#### Third Insert code

🤔 _You can improve the code. I'll leave that to your imagination._
...
PrismJS allows you to select which language you embedded and performs code highlighting according to the language. Neat!
